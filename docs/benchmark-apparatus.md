...
Companion to `docs/benchmark-protocol.md` (protocol version `1.5.3`).
...
2. **SE1 and SE2 are not that fallback.** Protocol 1.5.3 defines them as a
...
idle comparison (`docs/benchmark-results.md`). Under 1.5.3, W6 and the
