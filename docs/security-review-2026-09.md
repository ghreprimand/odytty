...
| 4 | `ttf-parser` RUSTSEC-2026-0192 | INFO | An "unmaintained" advisory, not a disclosed vulnerability or unsoundness. At review time `.github/scripts/rustsec-audit.sh` carried a dated exception expiring 2026-10-15. Closed 2026-09-19: normal-text parsing moved to `skrifa` and the Wayland decoration backend to `crossfont`, the crate left both lockfiles, and the exception block was removed; see [`docs/release.md`](release.md). |
