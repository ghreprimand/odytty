...
`odyssey-amber`), cool natural (`odyssey-glacier`, `odyssey-voyager`,
`odyssey-fathom`, `odyssey-harbor`, `odyssey-orchard`, `odyssey-tidepool`,
`odyssey-slate`, `odyssey-jungle`), cosmic nebula (`odyssey-nebula`,
