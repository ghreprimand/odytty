...
palette plus semantic roles, and a curated 145-theme library (dark and light,
all contrast-validated).
...
- **v0.15.0 - Theme-library expansion** is data-only. Electric Blue brings the
  built-in library to 145 themes. The preset uses the existing parser, picker,
...
3. **Execute the provisional release sequence above one checkpoint at a time.**
   ...
   reliability patch and the v0.15.6 cursor-glide regression fix; v0.16.0 is the
   next planned feature checkpoint.
