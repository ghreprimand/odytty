...
Merge and Pull palette and Session Navigator actions. No new fixed merge chord
is defined; the quick-terminal shortcut is set with `quick_terminal_shortcut`.
