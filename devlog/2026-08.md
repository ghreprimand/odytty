...
foreground, background, cursor, selection, and sixteen ANSI colors.
`red-planet-dark` keeps every foreground, cursor, selection, semantic accent,
and ANSI value identical while lowering only the background and clear roles
from `#222222` to `#161616`.
...
locks the darker variant to a canvas-only change.
