...
use super::{
    ALWAYS_SHOW_TAB_BAR_ENV, AUTOMATION_ENDPOINT_ENV, BACKGROUND_BLUR_RADIUS_ENV,
    BACKGROUND_IMAGE_ENV, BACKGROUND_IMAGE_SCRIM_ENV, BACKGROUND_TREATMENT_ENV, BELL_ENV,
    BLOOM_ENV, BLOOM_INTENSITY_ENV, BLOOM_RADIUS_ENV, BLOOM_THRESHOLD_ENV, BUTTONS_ENV,
    BUTTONS_ITERM_COMPAT_ENV, BUTTONS_STICKY_ENV, CELL_BG_OPACITY_ENV, COLORED_BG_OPACITY_ENV,
    COMMAND_STATUS_GUTTER_ENV, CONFIRM_CLOSE_ENV, COPY_ON_SELECT_ENV, CRT_CURVATURE_ENV, CRT_ENV,
    CRT_SCANLINE_INTENSITY_ENV, CRT_SCANLINE_PERIOD_ENV, CRT_VIGNETTE_STRENGTH_ENV,
    CURSOR_BLINK_ENV, CURSOR_EASING_ENV, CURSOR_GLOW_ENV, CURSOR_GLOW_INTENSITY_ENV,
    CURSOR_MOTION_ENV, CURSOR_STYLE_ENV, CURSOR_TRAIL_ENV, CURSOR_TRAIL_STRENGTH_ENV, CVD_MODE_ENV,
    CVD_STRENGTH_ENV, DEFAULT_LAUNCH_PROFILE_ENV, EXTERNAL_PALETTE_PATH_ENV,
    EXTERNAL_PALETTE_PROVIDER_ENV, FOCUS_DIM_ENV, FOLLOW_EXTERNAL_PALETTE_ENV, FOLLOW_OS_THEME_ENV,
    FONT_ENV, FONT_FAMILY_ENV, FONT_SIZE_ENV, FONT_WEIGHT_ENV, GEOMETRIC_BOXDRAW_ENV,
    INACTIVE_PANE_DIM_ENV, KEYBINDS_ENV, MIN_CONTRAST_ENV, NATIVE_AUTOCLOSE_ENV,
    NEW_OUTPUT_FADE_ENV, NEW_OUTPUT_FADE_MS_ENV, NOTIFICATIONS_ENV, OS_THEME_DARK_ENV,
    OS_THEME_LIGHT_ENV, OSC52_READ_ENV, OSC52_WRITE_ENV, PANE_PREFIX_ENV, PIXEL_SCROLL_ENV,
    PROFILE_AUTO_SWITCH_ENV, QUICK_TERMINAL_ANIMATION_ENV, QUICK_TERMINAL_COVERAGE_ENV,
    QUICK_TERMINAL_EDGE_ENV, QUICK_TERMINAL_ENV, QUICK_TERMINAL_HIDE_ON_FOCUS_LOSS_ENV,
    QUICK_TERMINAL_MONITOR_ENV, QUICK_TERMINAL_PROFILE_ENV, QUICK_TERMINAL_SHORTCUT_ENV,
    QUICK_TERMINAL_SPAN_ENV, REDUCED_MOTION_ENV, RENDER_QUALITY_ENV, RESTORE_WORKSPACES_ENV,
    ...
    SELECTION_OPACITY_ENV, SH_CLICK_ENV, SHELL_EXIT_CLOSES_ENV, SHELL_INTEGRATION_ENV,
    SHELL_KEY_ENHANCEMENT_ENV, SMART_CTRL_C_ENV, STEM_DARKEN_ENV, SUBPIXEL_ENV,
    SYMBOL_FALLBACK_ENV, SYMBOL_FONT_ENV, SYMBOL_MAP_ENV, SYNTHETIC_STYLES_ENV, TAB_BAR_HEIGHT_ENV,
    ...
    TAB_SEAM_ENV, TEXT_BRIGHTNESS_ENV, TEXT_GAMMA_ENV, THEME_ENV, THEMED_UI_ROLES_ENV, VISUAL_ENV,
...
pub(super) fn config_key_to_env(key: &str) -> Option<&'static str> {
    match normalize_name(key).as_str() {
        ...
        "defaultlaunchprofile" | "defaultprofile" | "default_launch_profile" => {
            Some(DEFAULT_LAUNCH_PROFILE_ENV)
        }
        ...
        "navigatorpreview" | "sessionnavigatorpreview" => Some(NAVIGATOR_PREVIEW_ENV),
        "automationendpoint" | "automation" | "localcontrol" => Some(AUTOMATION_ENDPOINT_ENV),
...
pub(crate) fn env_to_config_key(env: &str) -> Option<&'static str> {
    match env {
        ...
        DEFAULT_LAUNCH_PROFILE_ENV => Some("default_launch_profile"),
        ...
        NAVIGATOR_PREVIEW_ENV => Some("navigator_preview"),
        AUTOMATION_ENDPOINT_ENV => Some("automation_endpoint"),
