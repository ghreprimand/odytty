...
- **Visual layer:** 142 built-in themes, user `.theme` files, theme builder,
...
- **Visual and config:** 142 built-in themes, theme builder, bloom/CRT/retro
...
copy/paste, font/theme/settings overlays, theme builder, 142 themes, color
