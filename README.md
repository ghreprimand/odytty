...
- **Visual layer:** 136 built-in themes, user `.theme` files, theme builder,
...
`--list-themes` prints the 136 built-in themes as stable
...
- **Visual and config:** 136 built-in themes, theme builder, bloom/CRT/retro
...
copy/paste, font/theme/settings overlays, theme builder, 136 themes, color
